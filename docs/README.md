...
- [Development and testing](DEVELOPMENT.md) covers the pinned environment, commands, Cargo features, tests, lint rules, Nix packaging, Jujutsu usage, and release preparation.
